...
`duplicates.cy.js` standalone — it depends on data produced by `checksums.cy.js`.
...
| 4 | `rules.cy.js` | Adds, edits, deletes, and toggles admin rule definitions against a stateful stubbed API. |
